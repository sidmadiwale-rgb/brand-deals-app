...
# PSE icon embedded as base64 — no dependency on static folder being deployed correctly.
...
# Inject Apple/Android home-screen icon links using the embedded icon as a data URL.
# This way the home-screen icon works regardless of whether /static/ is reachable.
_ICON_URL = f"data:image/png;base64,{_ICON_BASE64}"
st.markdown(f"""
<link rel="apple-touch-icon" sizes="180x180" href="{_ICON_URL}">
<link rel="icon" type="image/png" href="{_ICON_URL}">
