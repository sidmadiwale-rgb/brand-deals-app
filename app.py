...
div[data-testid="stElementContainer"]:has(.card-overlay-trigger-lg)+div[data-testid="stElementContainer"] .stButton{margin-top:-150px;position:relative;z-index:5}
div[data-testid="stElementContainer"]:has(.card-overlay-trigger-lg)+div[data-testid="stElementContainer"] .stButton button{width:100%!important;min-height:146px!important;background:transparent!important;border:none!important;color:transparent!important;cursor:pointer!important;padding:0!important;font-size:0!important}
